...
export default class find_care_top_carousel_2 extends CardType {
  ...
  init_nav(status, card, container, home) {
    return new Promise((resolve, reject) => {
      Array.from(container.querySelectorAll(`[data-id=${this.id}] .slide`)).forEach(slide => slide.onclick = e => {
